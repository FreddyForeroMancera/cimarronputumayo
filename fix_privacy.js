...
for (const [lang, list] of Object.entries(data)) {
  ...
  if (fs.existsSync(filePath)) {
    ...
    if (json.Privacy && json.Privacy.sections && json.Privacy.sections[1] && json.Privacy.sections[1].list) {
      json.Privacy.sections[1].list = list;
      fs.writeFileSync(filePath, JSON.stringify(json, null, 2), 'utf8');
      console.log(`Updated privacy policy in ${lang}.json`);
    }
  }
}
